...
You can create, edit and delete projects by adding, modifying or removing `*.mdx` files in the `src/app/portfolio/projects` directory.
...
---`,
        language: "tsx",
        label: "src/app/portfolio/projects/project-1.mdx"
      }
    ]}
/>
