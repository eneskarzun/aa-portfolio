...
image: "/images/certificate/horizontal-2.jpg"
...
The code above will ensure that the `/certificate` page is not accessible and is not displayed in the navigation.
